        ...
        <el-table-column label="商品信息" min-width="300">
          <template slot-scope="scope">
            <div class="product-info">
              <el-image :src="$getImageUrl(scope.row.product.imageUrl)" :preview-src-list="[$getImageUrl(scope.row.product.imageUrl)]" fit="cover"
      ...
      <div class="order-detail">
        ...
        <div class="detail-section">
          ...
          <div class="product-detail-info">
            <el-image 
              :src="$getImageUrl(currentOrder?.product?.imageUrl)"
