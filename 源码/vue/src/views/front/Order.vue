  ...
  <div class="order-page">
          ...
          <div v-for="order in orders" :key="order.id" class="order-item">
            ...
            <div class="order-products">
              <div class="product-info">
                <el-image :src="order.product.imageUrl?.startsWith('http') ? order.product.imageUrl : $getImageUrl(order.product.imageUrl)" fit="cover"
                  class="product-image">
    ...
    <el-dialog title="商品评价" :visible.sync="reviewDialogVisible" width="500px">
      <div v-if="currentOrder" class="review-product-info">
        <el-image :src="currentOrder.product.imageUrl?.startsWith('http') ? currentOrder.product.imageUrl : $getImageUrl(currentOrder.product.imageUrl)" fit="cover"
